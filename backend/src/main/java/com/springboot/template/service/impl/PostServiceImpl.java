...
import com.springboot.template.mapper.PostFavourMapper;
import com.springboot.template.mapper.PostMapper;
import com.springboot.template.mapper.PostThumbMapper;
import com.springboot.template.model.dto.post.PostEsDTO;
import com.springboot.template.model.dto.post.PostQueryRequest;
import com.springboot.template.model.entity.Post;
import com.springboot.template.model.entity.PostFavour;
import com.springboot.template.model.entity.PostThumb;
...
import com.springboot.template.model.vo.PostVO;
import com.springboot.template.service.PostService;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        if (CollUtil.isNotEmpty(orTagList)) {
            ...
            boolQueryBuilder.filter(f -> f.bool(orTagBoolQueryBuilder.build()));
        }
        // 按关键词检索
        if (StringUtils.isNotBlank(searchText)) {
        ...
        if (StringUtils.isNotBlank(sortField)) {
            nativeQueryBuilder.withSort(s -> s.field(f -> f.field(sortField)
