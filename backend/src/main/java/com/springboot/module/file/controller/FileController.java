package com.springboot.module.file.controller;

import cn.hutool.core.io.FileUtil;
import com.springboot.common.BaseResponse;
import com.springboot.common.ErrorCode;
import com.springboot.common.ResultUtils;
import com.springboot.config.FileStorageConfig;
import com.springboot.constant.FileConstant;
import com.springboot.exception.BusinessException;
import com.springboot.module.file.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        File targetFile = new File(fileStorageConfig.getResolvedRootPath(), filepath);
